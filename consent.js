...
(function () {
  ...
  var CONFIG = {
    ...
    theme: {
      bg: '#ffffff', panelBg: '#f5f7fa', card: '#f5f7fa', track: '#e3e8ef',
      line: '#e3e8ef', lineHi: '#aab8c9',
      text: '#0b131c', muted: '#3a4757', dim: '#4b5768',
      accent: '#1c6cb4', accentHi: '#0f4f88', accentInk: '#ffffff',
      accentFade: 'rgba(28,108,180,.35)', accentWash: 'rgba(28,108,180,.14)',
      shadow: 'rgba(11,19,28,.16)',
